  ...
  <div class="col-lg-8 mx-auto p-4 py-md-5">
    ...
    <main>
      ...
      <section class="pb-4">
        ...
        <form action="" method="post" class="row justify-content-start">
          <div class="col-md-6">
            <div class="form-floating mb-2 mt-4">
              <input name="lecturer" type="text" class="form-control" id="lecturer" placeholder="Enter lecturer name" required>
              <label for="lecturer">Lecturer name</label>
            </div>
            <div class="form-floating mb-2">
              <input name="time" type="text" class="form-control" id="time" placeholder="Enter time of appointment" required>
